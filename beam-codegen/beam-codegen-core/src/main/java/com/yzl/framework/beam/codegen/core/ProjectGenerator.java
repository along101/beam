package com.yzl.framework.beam.codegen.core;

import com.google.common.collect.Lists;
import com.yzl.framework.beam.codegen.core.common.Info;
import com.yzl.framework.beam.codegen.core.utils.Utils;
import com.yzl.framework.beam.codegen.core.utils.mustache.MustacheProcessor;
...
public class ProjectGenerator {
    ...
    private void performProjectGenerator() throws Exception {
        ...
        mustacheParameters.put("beamVersion", Info.getInstance().getVersion());
