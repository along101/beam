...
import com.yzl.framework.beam.util.StringTools;
...
public class URL {
    ...
    public static URL valueOf(String url) {
        if (StringUtils.isBlank(url)) {
            throw new BeamServiceException("serviceUrl is null");
        }
    ...
    public boolean canServe(URL referUrl) {
        ...
        if (!StringUtils.equals(this.getParameter(URLParamType.nodeType.getName()), BeamConstants.NODE_TYPE_SERVICE)) {
            return false;
        }
        ...
        return version.equals(refVersion);
    }
    ...
    private String getMethodParameterKey(String methodName, String name) {
        return BeamConstants.METHOD_CONFIG_PREFIX + methodName + "." + name;
    }

    public String getUri() {
        return protocol + BeamConstants.PROTOCOL_SEPARATOR + host + BeamConstants.HOST_PORT_SEPARATOR + port
                + BeamConstants.PATH_SEPARATOR + StringUtils.removeStart(path, BeamConstants.PATH_SEPARATOR);
    }
